 ...
 * @method static Response|array approveChatJoinRequest(array $parameters, string $token = null)  Use this method to approve a chat join request. The bot must be an administrator in the chat for this to work and must have the *can_invite_users* administrator right. Returns *True* on success.
 * @method static Response|array declineChatJoinRequest(array $parameters, string $token = null)  Use this method to decline a chat join request. The bot must be an administrator in the chat for this to work and must have the *can_invite_users* administrator right. Returns *True* on success.
 ...
 * @method static Response|array deleteChatPhoto(array $parameters, string $token = null)  Use this method to delete a chat photo. Photos can't be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns *True* on success.
 * @method static Response|array setChatTitle(array $parameters, string $token = null)  Use this method to change the title of a chat. Titles can't be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns *True* on success.
 * @method static Response|array setChatDescription(array $parameters, string $token = null)  Use this method to change the description of a group, a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns *True* on success.
